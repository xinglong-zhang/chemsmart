...
Thank you for downloading and using chemsmart. Please confirm the operating system you are using and follow the corresponding installation steps. If you only need to use chemsmart on a High-Performance Computing (HPC) cluster, you can install chemsmart solely on the cluster. Refer to the **Tutorials - How to Use Chemsmart on Cluster** for guidance.
