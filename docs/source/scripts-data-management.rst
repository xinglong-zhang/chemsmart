...
This page documents file management scripts for organizing and converting
...
The ``file_organizer.py`` script organizes computational chemistry output
files based on an Excel spreadsheet. It creates folders, renames files,
and moves them to their corresponding directories.
