...
For one headless Ubuntu target-host example, use the staged instructions in :doc:`installation-ubuntu-cpu-server`. The
steps below cover workstation installation on Linux or macOS.
