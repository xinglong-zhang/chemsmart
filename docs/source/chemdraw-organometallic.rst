...
.. warning::
   ...
   **Always inspect the auto-generated 3D structures before submitting quantum chemistry calculations.**
   ...
   Use a molecular viewer (e.g. PyMOL, Avogadro, GaussView) to verify the structure before submitting.
