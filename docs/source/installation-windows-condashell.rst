...
This guide covers installing Chemsmart on Windows using Conda PowerShell. We still recommend installing and using
Chemsmart in a Linux-like environment such as WSL (Ubuntu).
...
#. Install the required software:
   ...
   -  **Conda**: Install either Anaconda3 or Miniconda3 for Windows from the `conda installation guide
      <https://docs.conda.io/projects/conda/en/stable/user-guide/install/index.html>`_. The Conda PowerShell Prompt is
