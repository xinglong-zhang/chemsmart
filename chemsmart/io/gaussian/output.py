...
class Gaussian16QMMMOutput(Gaussian16Output):
    """Class to parse the Gaussian QMMM / ONIOM output files.

    This class is used to parse the QMMM output files generated by Gaussian.
    It inherits from the Gaussian16Output class and adds additional functionality
    specific to QMMM / ONIOM calculations.
    """
