...
#         """
#         Create both QRCr and QRCf jobs for the given TS file.
#         Generates two GaussianGeneralJob objects, one for each
#         QRC job.
#         """
#         jobs = []
#         for direction in ["f", "r"]:
#             label = f"{self.label}_qrc{direction}"  # 1-indexed for conformers
#             jobs += [
#                 GaussianGeneralJob(
...
#         return jobs
#
#     def _prepare_qrcf_job(self):
#         """
#         Create QRC forward job based on the given amplitude.
#         """
#
#
