...
def build_gaussian_pka_settings(
    ...
    """Build Gaussian pKa settings from shared options and project settings."""
    import inspect
    ...
    def from_molecules(
        ...
        **kwargs,
        ...
        Args:
            ...
            shared: Shared pKa settings from CLI/project context.
            project_settings: Project settings object providing opt/sp defaults.
            job_settings: Optional job settings override.
            keywords: Gaussian keywords to merge into opt settings.
            jobrunner: JobRunner instance for execution.
            filename: Source filename used to derive fragment labels.
            skip_completed: Skip execution for completed jobs.
