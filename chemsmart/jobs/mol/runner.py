...
class PyMOLJobRunner(JobRunner):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        # None = unset: inherit SCRATCH=False for PyMOL jobs. YAML override
