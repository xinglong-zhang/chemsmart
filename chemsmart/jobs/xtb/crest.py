from chemsmart.jobs.xtb.job import XTBJob, XTBGeneralJob


class XTBCrestJob(XTBJob):
    """Object representing an XTB CREST job that takes in a list of molecules object."""
    ...
    def __init__(
        ...
        if not isinstance(molecules, list) or len(molecules) == 0:
            raise ValueError("Molecule must be a list of Molecule objects.")
        super().__init__(
