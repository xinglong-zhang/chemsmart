...
class BaseAssembler:
    ...
    def molecules_list(self):
        return Molecule.from_filepath(self.filename, index=self.index, return_list=True)
...
#           'is_aromatic': mol.is_aromatic,
    ...
    def get_calculation_results(self):
        ...
        if self.output.freq:
            calculation_results['vibrational_frequencies'] = self.output.vibrational_frequencies
            calculation_results['num_vib_frequencies'] = self.output.num_vib_frequencies
            calculation_results['rotational_symmetry_number'] = self.output.rotational_symmetry_number
