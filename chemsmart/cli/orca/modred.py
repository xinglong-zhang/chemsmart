...
@click_orca_jobtype_options
@click.pass_context
def modred(ctx, jobtype, coordinates, dist_start, dist_end, num_steps, **kwargs):
    if jobtype is None:
        jobtype = "modred"

    # get settings from project
    project_settings = ctx.obj["project_settings"]
    modred_settings = get_setting_from_jobtype_for_orca(project_settings, jobtype, coordinates, dist_start, dist_end, num_steps)
