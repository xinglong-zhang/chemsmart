    ...
    *,
    ...
    result_selector = {
        ...
        "description": (
            ...
            "electronic bond-order assignment. The wiberg_bond_orders "
            "selector returns sparse pair records as rows of "
            "[atom_i, atom_j, wiberg_bond_order] in 0-based molecular order; "
            "it is read from xTB's thresholded native sidecar, so an omitted "
            "pair has no reported value and is never a zero. The "
