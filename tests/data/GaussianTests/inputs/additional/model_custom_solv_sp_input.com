%chk=aldehyde_custom_solv_sp.chk
%nprocshared=24
%mem=60GB
# b3lyp empiricaldispersion=gd3bj def2tzvp scrf=(smd,solvent=generic,read)

From inputfile aldehyde.log
...
solventname=2-methoxy-2-methylpropane
eps=2.6
epsinf=1.86704896
HBondAcidity=0.00
HBondBasicity=0.54
