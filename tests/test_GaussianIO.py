...
class TestGaussian16Output:
    ...
    def test_read_oniom_outputfile(self, gaussian_oniom_outputfile):
        ...
        assert g16_oniom.oniom_cutting_bonds == {(49,50):(0.700189,0.700189),\
        ...
        assert g16_oniom.oniom_get_charge_and_multiplicity=={'low-level, real system':(1,2),\
                                                             'high-level, model system':(1,1),\
                                                             'low-level, model system':(1,1)}
        assert g16_oniom.oniom_getting_layer_energies=={'high-level, model system': -5303.002072980664,\
