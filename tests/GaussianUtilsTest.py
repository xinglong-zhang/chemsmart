import numpy as np
from chemsmart.utils.utils import get_list_from_string_range, str_indices_to_list
...
class TestGetListFromStringRange:
    def test_get_list_from_string_range(self):
        ...
        assert s1_list == [0, 1, 2, 27, 28, 29, 30, 33, 34, 35, 36, 37, 38, 39, 40]

        s2 = '1-3,28-31,34-41'
        s2_list = get_list_from_string_range(string_of_range=s2)
        assert s2_list == [0, 1, 2, 27, 28, 29, 30, 33, 34, 35, 36, 37, 38, 39, 40]
